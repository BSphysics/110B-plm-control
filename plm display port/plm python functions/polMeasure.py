...
def pol_measure(camera, global_amplitudes, beamName, exposure_time, * , beamAPhaseShift=None, multiBeamFilePath=None , poincareBeamFilePath=None):

    config_path = None

    if poincareBeamFilePath is not None:
        config_path = poincareBeamFilePath
    elif multiBeamFilePath is not None:
        config_path = multiBeamFilePath
    ...
    # ============================================================
    # SAVE COPY OF SLM CONFIG (.xlsx) IF PROVIDED
    # ============================================================
    ...
    if config_path is not None:
        if os.path.exists(config_path):
            ...
            print(f"Copied config file to:\n{dest_path}")
        else:
            print("Warning: Config file path does not exist.")



    del all_images

    return filename , time_folder        